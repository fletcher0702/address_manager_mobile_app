...
class HomeState extends State<Home> {
  ...
  * */
  ...
  void loadVisits() async {
    if (!visitsToggle) {
      visits = await visitController.findVisitsByZoneId("");

      visits.forEach((visitsItem) {
        visitsElements.add(visitsItem);
      });
      visitsToggle = true;
    }
  }
                ...
                child: DropdownButton(
                  ...
                  onChanged: (value) {
                    setState(() {
                      ...
                      String selectedId = zoneController
                          .getId(zonesElements[_selectedZoneIndex]["_id"]);
                      var visits =
                          visitController.findVisitsByZoneId(selectedId);
                      visits.then((visitsItems) {
                        loadMarkers(visitsItems);
                        visitsElements = visitsItems;
                      });
                    });
                  },
                ),
          ...
          IconButton(
            ...
            onPressed: () {
              if (selectedZone != null) {
                addPersonDialog
                    .dialog(context, zonesElements, _selectedZoneIndex, () {
                  print('Person added !');
                });
              } else {
                showDialog(
